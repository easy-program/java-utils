...
import enumeration.PictureType;
...
public class PDFUtils {
	 ...
	 * @return
	 */
	public static List<String> pdfToImagePath(String filePath, PictureType pictureType) {
		...
		try {
			...
			for (int i = 0; i < pageCount; i++) {
				...
				ImageIO.write(image, pictureType.toString(), new File(imagePath));
				list.add(imagePath);
			}
			// 关闭文件,不然该pdf文件会一直被占用
			doc.close();
